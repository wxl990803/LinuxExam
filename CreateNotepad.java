...
public class CreateNotepad extends HttpServlet {
    ...
    final static String URL = "jdbc:mysql://180.76.184.27/linux_exam";
    final static String USER = "root";
    final static String PASS = "Wxl1234.";
    final static String SQL_INSERT_NOTEPAD = "INSERT INTO notepad(id,notepadContent,notepadTime) VALUES (?,?, ?)";
